...
vcom -2008 -work work ../src/day_1_solution_adder_tree.vhd
vcom -2008 -work work ../src/day_1_solution_count_zero.vhd
...
vcom -2008 -work work tb_top.vhd
vcom -2008 -work work tb_file_input.vhd
